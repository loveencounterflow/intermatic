(function() {
  ...
  Intermatic = (function() {
    ...
    class Intermatic {
      ...
      //---------------------------------------------------------------------------------------------------------
      fail() {
        throw new Error(`^interstate/fail@557^ trigger not allowed: ${rpr({
          name: this.name,
          verb: this.verb,
          dpar: this.dpar
        })}`);
...
//.......................................................................................................
      ...
      _get_transitioner(verb, dests_by_deps = null) {
        ...
        return transitioner = (...P) => {
          var base, base1, base10, base11, base2, base3, base4, base5, base6, base7, base8, base9, changed, dest, dpar, i, len, ref, ref1, subfsm_name;
