...
//.......................................................................................................
      ...
      _get_transitioner(verb, destinations_by_departures = null) {
        ...
        return transitioner = (...P) => {
          var base, base1, base10, base11, base2, base3, base4, base5, base6, base7, base8, base9, changed, departure, destination, id, ref, trigger;
          ...
          this._nxt_departure = departure = this.lstate;
          id = this._new_tid();
          //-------------------------------------------------------------------------------------------------
          if (destinations_by_departures != null) {
            this._nxt_destination = destination = (ref = destinations_by_departures[departure]) != null ? ref : null;
            if (destination == null) {
              trigger = freeze({
                id,
                failed: true,
    ...
    Object.defineProperties(Intermatic.prototype, {
      ...
      departure: {
        get: function() {
          return this._nxt_departure;
        }
      },
      //-------------------------------------------------------------------------------------------------------
      destination: {
        get: function() {
          return this._nxt_destination;
        }
      },
      //-------------------------------------------------------------------------------------------------------
      verb: {
